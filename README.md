...
mkdir -p assets/css && touch assets/css/{output,override,override-fonts}.css
# brew install node # if you don't have npm installed
cp themes/henry/tailwind.config.henry.js ./tailwind.config.js
npm install -D tailwindcss @tailwindcss/cli 
npx @tailwindcss/cli -i themes/henry/assets/css/input.css -o ./assets/css/output.css --watch
